...
`;
  ...
  document.getElementById("show-deleted").addEventListener("click", async () => {
    ...
    const res = await fetch("api.php?action=admin_get_deleted_orders");
    ...
    document.querySelectorAll(".restore-link").forEach(link => {
      link.addEventListener("click", async () => {
        ...
        await fetch("api.php?action=admin_restore_order", {
          method: "POST",
...
async function loadOrdersIntoTable() {
  const tbody = document.getElementById("orders-body");
  tbody.innerHTML = "";
  const res = await fetch("api.php?action=admin_get_orders_table");
  const data = await res.json();
...
async function deleteOrderById(id) {
  const res = await fetch("api.php?action=admin_delete_order", {
    method: "POST",
    headers: {
...
document.getElementById("reject-save-btn").onclick = async () => {
  ...
  await fetch("api.php?action=admin_update_order_status", {
    method: "POST",
...
async function fetchProducts() {
  const res = await fetch("api.php?action=admin_get_all_products");
  const data = await res.json();
...
document.querySelector(".pm-update-btn").addEventListener("click", async () => {
  ...
  await fetch("api.php?action=admin_update_product", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
    body: new URLSearchParams({
      id,
...
document.querySelector(".pm-disable-btn").addEventListener("click", async () => {
  await fetch("api.php?action=admin_change_product_status", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
    body: new URLSearchParams({
...
document.getElementById("product-image-input").onchange = async function (e) {
  ...
  const res = await fetch("api.php?action=upload_product_image", {
    method: "POST",
    body: formData
  });
...
document.getElementById("pm-add-btn").addEventListener("click", async () => {
  ...
  const res = await fetch("api.php?action=admin_add_product", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
    body: new URLSearchParams({
      name,
...
async function deleteCustomer(userId) {
  await fetch("api.php?action=admin_delete_customer", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
    body: `id=${userId}`
  });
...
async function showDeletedCustomers() {
  ...
  const res = await fetch("api.php?action=admin_get_deleted_customers");
  const data = await res.json();
  ...
  document.querySelectorAll(".restore-link").forEach(link => {
    link.addEventListener("click", async () => {
      ...
      await fetch("api.php?action=admin_restore_customer", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
        body: `id=${id}`
      });
...
async function fillCustomersTable() {
  ...
  for (let index = 0; index < users.length; index++) {
    ...
    const addrRes = await fetch(`api.php?action=get_addresses&user_id=${user.id}`);
    const addresses = await addrRes.json();

    const firstAddress = addresses.length > 0 ? addresses[0].location : "-";

    // تعداد سفارش‌ها از دیتابیس
    const orderRes = await fetch(`api.php?action=admin_get_user_orders&user_id=${user.id}`);
...
async function openCustomerOrdersModal(userId) {
  ...
  const res = await fetch(`api.php?action=admin_get_user_orders&user_id=${userId}`);
  const data = await res.json();
...
async function loadMessagesIntoTable() {
  ...
  const res = await fetch("api.php?action=admin_get_all_messages");
  const data = await res.json();
...
async function deleteMessage(id) {
  await fetch("api.php?action=admin_delete_message", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
    body: `id=${id}`
  });
...
async function showDeletedMessages() {
  ...
  const res = await fetch("api.php?action=admin_get_deleted_messages");
  const data = await res.json();
  ...
  document.querySelectorAll(".restore-link").forEach(el => {
    el.onclick = async () => {
      await fetch("api.php?action=admin_restore_message", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
async function openMessageModal(id) {
  ...
  document.getElementById("msg-confirm-btn").onclick = async () => {
    ...
    await fetch("api.php?action=admin_reply_message", {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
async function loadTicketsIntoTable() {
  ...
  const res = await fetch("api.php?action=admin_get_all_tickets");
  const data = await res.json();
...
async function deleteTicket(id) {
  ...
  await fetch("api.php?action=admin_delete_ticket", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
    body: `id=${id}`
  });
...
async function showDeletedTickets() {
  ...
  const res = await fetch("api.php?action=admin_get_deleted_tickets");
  const data = await res.json();
  ...
  document.querySelectorAll(".restore-link").forEach(link => {
    link.addEventListener("click", async () => {
      ...
      await fetch("api.php?action=admin_restore_ticket", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
        body: `id=${id}`
      });
...
async function loadAdminHeaderAvatar() {
  ...
  const res = await fetch("api.php?action=admin_get_profile&id=" + logged.id);
  const data = await res.json();
...
async function openTicketModal(id) {
  ...
  const res = await fetch("api.php?action=admin_get_single_ticket&id=" + id);
  const data = await res.json();
  if (data.status !== "success") return;
  ...
  document.getElementById("ticket-confirm-btn").onclick = async () => {
    ...
    await fetch("api.php?action=admin_reply_ticket", {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
      body: `id=${id}&reply=${encodeURIComponent(reply)}`
    });
...
async function fetchUsersFromDatabase() {
  const res = await fetch("api.php?action=admin_get_all_users");
  const data = await res.json();
...
async function fetchAdminsFromDatabase() {
  const res = await fetch("api.php?action=admin_get_all_admins");
  const data = await res.json();
...
async function renderSettingsPage() {
  ...
  async function loadAdminInfo() {
    ...
    const res = await fetch("api.php?action=admin_get_admin&id=" + loggedAdmin.id);
    const data = await res.json();
  ...
  if (loggedAdmin.role === "orders") {
    ...
    const res = await fetch(`api.php?action=admin_get_profile&id=${loggedAdmin.id}`);
    const data = await res.json();
  ...
  shippingSaveBtn.addEventListener("click", async () => {
    ...
    const res = await fetch("api.php?action=admin_update_shipping_fee", {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
      body: `fee=${fee}`
    });
  ...
  function bindDiscountHistoryEvents() {
    ...
    btnActive.onclick = async () => {
      ...
      await fetch("api.php?action=admin_set_discount_status", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
  ...
  if (discountSaveBtn && discountPercentInput && discountCodeInput) {
    discountSaveBtn.addEventListener("click", async () => {
      ...
      await fetch("api.php?action=admin_save_discount_code", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
        body:
  ...
  async function openRoleModalForUser() {
    ...
    const res = await fetch(`api.php?action=admin_get_user_role&email=${email}`);
    const data = await res.json();
  ...
  document.getElementById("role-save-btn").onclick = async () => {
    ...
    await fetch("api.php?action=admin_update_user_role", {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
async function activateAdminSettingsLogic() {
  ...
  avatarInput.onchange = async (e) => {
    ...
    const res = await fetch("api.php?action=admin_upload_avatar", {
      method: "POST",
      body: formData
    });
  ...
  saveBtn.onclick = async () => {
    ...
    if (oldPass || newPass || repeatPass) {
      ...
      const passRes = await fetch("api.php?action=admin_change_password", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
    ...
    await fetch("api.php?action=admin_update_info", {
      method: "POST",
      headers: { "Content-Type": "application/x-www-form-urlencoded" },
      body:
        `id=${loggedAdmin.id}` +
...
async function loadDiscountCodes() {
  const res = await fetch("api.php?action=admin_get_discount_codes");
  const data = await res.json();
...
async function getAllOrders() {
  const res = await fetch("api.php?action=admin_get_all_orders");
  const data = await res.json();
